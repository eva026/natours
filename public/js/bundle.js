...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZXZhMDI2IiwiYSI6ImNrYnFjYnR5NjJoeHgyc3BmMzhkaTAzeGUifQ.Z0sNJF7yjnk7Ma50m4z8MA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/eva026/ckbr9ca3q62eu1io27lpe4m8k',
    scrollZoom: false // center: [-118.247225, 34.046353],
    // zoom: 10,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    var marker = new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Extend map bounds
...
var stripe = Stripe('pk_test_51H0NlNGsIgwQpNhGpq0rxrzG1c3CyGnVt5NqsDEPuG9iHSS0FWex7MYyWaS9vOZkgHdCJBs0YhvE5HdK65RWyTwS003rmJ5PBS');
